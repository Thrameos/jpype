...
# Android has no jar/jrt filesystem for jpype.JPackage/jpype.imports-style
# attribute access to resolve platform packages against (see doc/android.rst,
# "Removed JPype Services"). Unlike the desktop version of this file, which
# uses jpype.java.lang.Character directly, every such reference here goes
# through this explicit JClass lookup instead.
JCharacter = jpype.JClass('java.lang.Character')
...
class JCharTestCase(common.JPypeTestCase):
    ...
    def testPass(self):
        ...
        self.assertEqual(type(fixture.callObject(self.nc)), JCharacter)
...
class JCharBoxedNullTestCase(common.JPypeTestCase):
    def setUp(self):
        common.JPypeTestCase.setUp(self)
        self.nc = jpype.JObject(None, JCharacter)
