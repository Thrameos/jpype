...
public class PyBytesIONGTest extends PyTestHarness
{
  ...
  {
    PyBytesIO instance = context.bytesIO();
  ...
  {
    PyBytesIO instance = context.bytesIO(context.bytesFromHex("616263"));
  ...
  {
    PyBytesIO instance = context.bytesIO(context.bytesFromHex("616263646566"));
