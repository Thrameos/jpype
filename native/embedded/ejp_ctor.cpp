...
static jsize toArg(vector<JPPyObject>& args, JPJavaFrame& frame, jobjectArray elements)
{
...
(JNIEnv *env, jclass, jobjectArray elements)
{
	...
	jsize sz = toArg(args, frame, elements);
...
(JNIEnv *env, jclass cls, jobjectArray elements)
{
